# Author: 1rgs
# GitHub Repo: https://github.com/1rgs/jsonformer
...
from transformers import LogitsProcessor, LogitsProcessorList, PreTrainedModel, PreTrainedTokenizer, StoppingCriteria
...
class Jsonformer:
    ...
    def __init__(
        ...
        *,
        ...
        self.number_logit_processor = LogitsProcessorList([OutputNumbersTokens(self.tokenizer, self.prompt)])
